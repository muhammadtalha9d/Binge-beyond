...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-50 top-0 transition-all duration-300 bg-gray-950/90 backdrop-blur-md border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-indigo-500 text-white hover:bg-indigo-600 px-6 py-2.5 rounded-full font-semibold text-sm transition-transform hover:scale-105 active:scale-95 flex items-center gap-2">
              Install App
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="text-left order-2 lg:order-1">
            <p className="text-indigo-400 font-bold tracking-widest text-sm mb-4 uppercase">Unlock Global Catalogues</p>
           
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-tight mb-6">
              You pay for 100%. <br />
              <span className="text-indigo-400">Stop settling for 10%.</span>
            </h1>
           
            <p className="text-lg md:text-xl text-gray-400 mb-4 leading-relaxed max-w-lg">
              Watch any show, movie, or live sports event from any country. BingeBeyond is a new way to explore global libraries using the streaming apps you already have.
            </p>


            <p className="text-lg md:text-xl text-gray-400 mb-10 leading-relaxed max-w-lg">
              BingeBeyond unlocks geo-blocked content and adds a high-speed express lane to Netflix, Disney Plus, Hulu, Max, and live sports networks.
            </p>
           
            <div className="flex flex-col sm:flex-row items-start gap-6">
              <button className="w-full sm:w-auto bg-indigo-500 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-indigo-600 transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(99,102,241,0.4)]">
                Install BingeBeyond
              </button>
             
              <div className="flex flex-col justify-center text-gray-400 text-sm font-medium sm:h-14">
                <span className="mb-1">Available for:</span>
                <div className="flex items-center gap-3">
                  <span className="flex items-center gap-1 hover:text-white cursor-pointer transition-colors"><AndroidIcon size={18}/> Android</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative mt-8 lg:mt-0 order-1 lg:order-2">
            <div className="relative bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl p-4 overflow-hidden transform md:rotate-2 hover:rotate-0 transition-transform duration-500 max-w-lg mx-auto lg:ml-auto lg:mr-0">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="bg-gray-800 rounded-xl p-4 flex flex-col justify-end h-48 relative group cursor-pointer border border-gray-700 hover:border-indigo-500 transition-colors shadow-lg">
                    <div className="absolute top-3 right-3 bg-gray-900/80 px-2 py-1 rounded text-[10px] font-bold text-gray-300">{item.region}</div>
                    <div>
...
const Hero2 = () => {
  return (
    <div className="relative pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden bg-gray-900 border-t border-gray-800">
      <div className="absolute top-0 left-0 bg-indigo-500 text-white px-4 py-1 font-bold text-xs rounded-br-lg z-50 tracking-widest uppercase">
        Hero Option V2
      </div>
     
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-indigo-600/15 rounded-full blur-[150px] pointer-events-none" />
     
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-tight mb-6">
          Watch Shows, Movies & Live Sports — <br className="hidden md:block" />
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          <button className="bg-indigo-500 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-indigo-600 transition-transform hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(99,102,241,0.4)] flex items-center gap-2">
            <AndroidIcon size={24} />
            Download BingeBeyond
          </button>
          <p className="text-sm text-gray-500 font-medium">Available exclusively on Android</p>
        </div>
      </div>
    </div>
  );
...
const Logos = () => {
  ...
  return (
    <div className="py-6 bg-gray-900 border-y border-gray-800 flex items-center overflow-hidden">
      <style>{`
      ...
      <div className="max-w-7xl mx-auto px-4 w-full flex items-center">
        {/* Static Left Side */}
        <div className="relative z-20 pr-6 md:pr-10 bg-gray-900 border-r border-gray-800 flex-shrink-0 flex items-center h-12">
        ...
        <div className="flex-1 overflow-hidden relative ml-4 md:ml-8 h-12 flex items-center">
          {/* Fade Edges */}
          <div className="absolute top-0 left-0 w-16 h-full bg-gradient-to-r from-gray-900 to-transparent z-10 pointer-events-none"></div>
          <div className="absolute top-0 right-0 w-16 h-full bg-gradient-to-l from-gray-900 to-transparent z-10 pointer-events-none"></div>
...
const ProblemSection = () => {
  return (
    <div id="problem" className="py-24 bg-gray-900 border-y border-gray-800 relative overflow-hidden">
      <div className="absolute inset-0 opacity-20 pointer-events-none bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-red-900/20 via-gray-900 to-gray-900"></div>
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gray-950 border border-red-500/30 rounded-2xl p-10 md:p-14 flex flex-col items-center text-center shadow-[0_0_50px_rgba(239,68,68,0.1)] relative overflow-hidden group">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-white font-bold text-xl mb-2">No new apps</h3>
            <p className="text-gray-400">Keep using the streaming apps already installed on your phone.</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-white font-bold text-xl mb-2">No switching platforms</h3>
            <p className="text-gray-400">Browse what's available globally from one central hub.</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-white font-bold text-xl mb-2">No complicated setup</h3>
            <p className="text-gray-400">It just works in the background. Zero tech skills required.</p>
          </div>
        </div>
      </div>
    </div>
...
const ContentShowcase = () => {
  ...
  return (
    <div className="py-24 bg-gray-950 border-b border-gray-800 overflow-hidden relative">
      <style>{`
      ...
      <div className="relative w-full flex flex-col gap-6 select-none opacity-90">
        ...
        <div className="animate-scroll-left flex gap-6 px-3">
          {[...row1, ...row1].map((item, idx) => (
            <div key={idx} className={`flex-shrink-0 w-72 rounded-2xl border border-gray-700/80 p-5 flex flex-col justify-between h-44 cursor-pointer hover:scale-105 hover:border-gray-500 transition-all duration-300 relative overflow-hidden group shadow-lg`}>
              {/* Background Image & Overlay */}
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110 bg-gray-800" style={{ backgroundImage: `url(${item.image})` }}></div>
              <div className="absolute inset-0 bg-gradient-to-t from-gray-950 via-gray-900/80 to-gray-900/30 group-hover:via-gray-900/60 transition-colors duration-300"></div>
             
              <div className="flex justify-between items-start relative z-10">
                <span className={`text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wider bg-gray-950/80 border border-gray-700/50 ${item.color}`}>{item.category}</span>
...
const VisualSmartRoute = () => (
  <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-950 p-8 gap-6">
    <div className="w-full bg-gray-900 border border-indigo-500/30 rounded-xl p-4 flex items-center relative overflow-hidden shadow-lg">
    ...
    <div className="w-full bg-gray-900 border border-gray-700 rounded-xl p-4 flex items-center relative overflow-hidden opacity-60 shadow-lg">
      ...
      <div className="bg-gray-800 text-gray-400 text-[10px] font-bold px-3 py-1.5 rounded-full">
         Local Internet
      </div>
    </div>
  </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className={`order-2 ${reverse ? 'lg:order-2' : 'lg:order-1'}`}>
          <div className="relative rounded-2xl bg-gray-900 border border-gray-800 p-2 shadow-2xl overflow-hidden aspect-[4/3] flex items-center justify-center">
            {visual}
          </div>
        </div>
...
const VisualPerformance = () => (
  <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-950 p-8">
...
const VisualAutoConnect = () => (
  <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-950 p-8 gap-4">
    <div className="w-full bg-gray-900 border border-indigo-500/30 rounded-xl p-3 flex items-center gap-3 shadow-lg">
...
const HowItWorks = () => {
  return (
    <div id="how-it-works" className="py-24 bg-gray-950 border-t border-gray-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-5xl font-bold text-white mb-16 text-center">Start watching in 4 easy steps</h2>
       
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col items-center text-center group">
            <div className="w-16 h-16 rounded-2xl bg-gray-900 border border-gray-700 flex items-center justify-center text-2xl font-bold text-white mb-6 group-hover:border-indigo-500 transition-colors shadow-lg">1</div>
            <h3 className="text-lg font-bold text-white mb-3">Get the App</h3>
            <p className="text-gray-400 text-sm">Download BingeBeyond on your phone or smart TV.</p>
          </div>


          <div className="flex flex-col items-center text-center group">
            <div className="w-16 h-16 rounded-2xl bg-gray-900 border border-gray-700 flex items-center justify-center text-2xl font-bold text-white mb-6 group-hover:border-indigo-500 transition-colors shadow-lg">2</div>
            <h3 className="text-lg font-bold text-white mb-3">Select Your Apps</h3>
            <p className="text-gray-400 text-sm">Pick the streaming apps you already have installed. No need to share your passwords with us.</p>
          </div>


          <div className="flex flex-col items-center text-center group">
            <div className="w-16 h-16 rounded-2xl bg-gray-900 border border-gray-700 flex items-center justify-center text-2xl font-bold text-white mb-6 group-hover:border-indigo-500 transition-colors shadow-lg">3</div>
            <h3 className="text-lg font-bold text-white mb-3">Discover Beyond</h3>
            <p className="text-gray-400 text-sm">Browse our hub to explore shows and live sports available in different regions worldwide.</p>
          </div>


          <div className="flex flex-col items-center text-center group">
            <div className="w-16 h-16 rounded-2xl bg-indigo-500 border border-indigo-400 flex items-center justify-center text-2xl font-bold text-white mb-6 shadow-[0_0_20px_rgba(99,102,241,0.4)]">4</div>
            <h3 className="text-lg font-bold text-white mb-3">Hit Play</h3>
            <p className="text-gray-400 text-sm">Click play on any title. We auto-connect the VPN in the background so you can watch instantly.</p>
          </div>
        </div>
      </div>
    </div>
...
const TrustSection = () => (
  <div id="trust" className="py-20 bg-gray-900/50 border-y border-gray-800/50">
    <div className="max-w-4xl mx-auto px-4 text-center">
    ...
    <div className="min-h-screen bg-gray-950 font-sans text-gray-100 selection:bg-indigo-500/30">
      ...
      <main>
        <div className="relative">
          <div className="absolute top-20 left-0 bg-gray-700 text-white px-4 py-1 font-bold text-xs rounded-br-lg z-50 tracking-widest uppercase">
            Hero Option V1
          </div>
          <Hero />
        </div>
        ...
        <div id="features" className="py-24 bg-gray-950 relative border-b border-gray-800">
        ...
        <div className="py-24 relative overflow-hidden bg-gray-900">
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
            ...
            <button className="bg-indigo-500 text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-indigo-600 transition-transform hover:scale-105 active:scale-95 shadow-xl flex items-center justify-center gap-2 mx-auto">
              <AndroidIcon size={24} /> Install BingeBeyond Free
            </button>
            <p className="mt-4 text-sm text-gray-500">Available exclusively on Android</p>
          </div>
        </div>
