...
// No more grouping needed! Loop directly through the length of the array.
    ...
    return (
      ...
      `}</style>
            ...
            <section className="mt-20 lg:mt-0 relative h-[90vh] w-full overflow-hidden flex items-center bg-[radial-gradient(circle_at_top_left,_#22393F_0%,_#10202B_100%)] z-10">
            ...
            <section className="bg-[radial-gradient(circle_at_top_left,_#22393F_0%,_#10202B_100%)] border-y border-white/15 shadow-2xl flex items-center overflow-hidden backdrop-blur-2xl z-10">
            ...
            {/* SCANNER SECTION */}
                ...
                <section ref={sectionRef} className="py-20 bg-[radial-gradient(circle_at_top_left,_#22393F_0%,_#10202B_100%)] px-6 relative overflow-hidden z-10 text-center">
                    <div className="depth-wash-light" />
                    <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center">
                        <div className="space-y-6 text-white mb-20 max-w-4xl">
                            <h2 className="text-[44px] font-black tracking-tighter uppercase leading-[1.1]">
